...
legend(8,0.05, legend=c("Male", "Female"), col=c("black", "red"), lty = c(1,1), cex=0.8)
```
...
legend(8,0.05, legend=c("Black", "Non-Black"), col=c("black", "red"), lty = c(1,1), cex=0.8)
```
###Hispanic
...
legend(8,0.05, legend=c("Hispanic", "Non-Hispanic"), col=c("black", "red"), lty = c(1,1), cex=0.8)
```
...
legend(8,0.05, legend=c("4 Symptoms", "3 Symptoms", "2 Symptoms", "1 Symptom"), col=c("black", "red", "yellow", "green"), lty = c(1,1), cex=0.8)
```
